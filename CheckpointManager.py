...
class CheckpointManager:
    ...
    def init_checkpoints(self):
        self.checkpoints.append(Checkpoint((56.29, 300.03), (60.0, 308.61)))  # 1
        ...
        self.checkpoints.append(Checkpoint((75.25, 234.85), (82.21, 243.01)))  # 6
        self.checkpoints.append(Checkpoint((101.19, 234.56), (105.04, 242.99)))  # 7
        self.checkpoints.append(Checkpoint((120.11, 234.95), (125.84, 242.78)))  # 8
        ...
        self.checkpoints.append(Checkpoint((142.63, 185.11), (146.67, 193.79)))  # 12
        ...
        self.checkpoints.append(Checkpoint((187.23, 199.77), (195.71, 202.44)))  # 15
...
class Checkpoint:
    ...
    def init_checkpoints(self):
        #self.checkpoints.append(Checkpoint((65.29, 300.03), (69.0, 310.61)))  # 1
